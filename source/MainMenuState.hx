...
class MainMenuState extends MusicBeatState
{
	...
	public static var curModVer:String = 'port 1.0'; //This is also used for Discord RPC
	...
	public static var daRealEngineVer:String = ' ';
	...
	override function create()
	{
		...
		versionShit.setFormat("Comic Sans MS Bold", 16, FlxColor.WHITE, LEFT, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
		add(versionShit);
		var versionShit:FlxText = new FlxText(12, FlxG.height - 24, 0, curModVer + ' ' + "original mod Vs Dave And Bambi 2.5c", 12);
		versionShit.scrollFactor.set();
		versionShit.setFormat("Comic Sans MS Bold", 16, FlxColor.WHITE, LEFT, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
		add(versionShit);
